...
def trainer_synapse(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        if (epoch_num == 80 or epoch_num == 90 or (
                epoch_num > int(max_epoch / 2) and (epoch_num + 1) % save_interval == 0)):
...
#         args.base_lr *= args.batch_size / 24
    ...
    args.exp = 'BS-Mamba' + dataset_name + str(args.img_size)
    snapshot_path = "./model/{}/{}".format(args.exp, 'BUSI')
    ...
    print(net)
    # input_shape = (3, args.img_size, args.img_size)  # 修正输入形状的定义
    # summary = summary(net, input_size=(1, 3, 224, 224))
    # print(summary)
